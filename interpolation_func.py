...
theta_avg = np.pi-np.arctan(np.sqrt(8))

N0 = np.linspace(0,3)*1e-17
...
inF = (4+3*np.cos(theta2/2)**2)*(alpha*theta_avg)**2*np.sqrt(2)*N0*7*J
...
inF = (4+3*np.cos(theta2/2)**2)*(alpha*theta_avg)**2*np.sqrt(2)*S1Hz*np.log(7*J/(fs/N))
